...
Spry.Widget.MenuBar.prototype.init = function(element, opts) {
	...
	var isie = (typeof document.all != 'undefined'
			&& typeof window.opera == 'undefined' && navigator.vendor != 'KDE');
...
Spry.Widget.MenuBar.prototype.addEventListener = function(element, eventType,
		handler, capture) {
	try {
...
function goTopExForFirefox() {
	...
	obj.onclick = function() {
		var goTop = setInterval(scrollMove, 0.0001);
		function scrollMove() {
